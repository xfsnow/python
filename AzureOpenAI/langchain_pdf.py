...
# Load the document
loader = UnstructuredFileLoader('./AzureOpenAI/gpt-4.pdf')
...
# Create the chain
embeddings = OpenAIEmbeddings(client=OPENAI_API_KEY, allowed_special={'<|endofprompt|>'})
...
chain = RetrievalQA.from_chain_type(
    ...
    chain_type='stuff', 
    retriever = retriever)
query = 'What are the Limitations of this Technical Report?'
